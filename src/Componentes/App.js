...
class App extends React.Component {
 ...
 //   this.arreglosReporte = this.arreglosReporte.bind(this);
  ...
  //Articulo
   this.registroArticulo = this.registroArticulo.bind(this);
  }
componentDidUpdate(){
          ...
          <div className="row">
            <div className="  col-md-12">
              ...
              <div id="mySidebar" class="sidebar">
                ...
                <a href="#" onClick={this.registroArticulo}>Registrar Articulo</a>
...
registroArticulo=(e)=>{
  ...
  browserHistory.push(this.state.name+'/articulo');
  e.preventDefault();
